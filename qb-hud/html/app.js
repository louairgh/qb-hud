    ...
    methods: {
        hudTick(data) {
            ...
            if (data.SafeZone === true) {
                ...
                $('#safeZone1').addClass('text-SafeZone');
                $('#safeZone2').addClass('text-SafeZone');
                $('#safeZone1').removeClass('text-NoSafeZone');
                $('#safeZone2').removeClass('text-NoSafeZone');
              } else {
                this.showSafeZone = false;
                $('#safeZone1').addClass('text-NoSafeZone');
                $('#safeZone2').addClass('text-NoSafeZone');
                $('#safeZone1').removeClass('text-SafeZone');
                $('#safeZone2').removeClass('text-SafeZone');
              }
